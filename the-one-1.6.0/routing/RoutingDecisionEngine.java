...
public interface RoutingDecisionEngine
{
	 ...
	 */
	public boolean shouldSendMessageToHost(Message m, DTNHost otherHost,ArrayList interest);
	 ...
	 */
	public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost,ArrayList interest);
	 ...
	 * @return true if the message should be deleted. False otherwise.
	 */
	public boolean shouldDeleteOldMessage(Message m, DTNHost hostReportingOld,ArrayList interest);
