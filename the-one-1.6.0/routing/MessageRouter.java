...
//        nodeInterest = s.getSetting("nodeList");
        ...
        nodeStatus = s.getSetting("nodeStatus");
    }
...
//            }
//        }
        String[] splittednode = nodeStatus.split("/");
...
//            this.status = "relay";
//        }
        for (String string : splittednode) {
            String[] temp = string.split(":");
            String val = temp[0];
            String[] nodeInter = temp[1].split(",");
            for (String stringKey : nodeInter) {
            ...
            case Q_POPULARITY:
                Collections.sort(list,
                    ...
                    public int compare(Object o1, Object o2) {
                        ...
                        Double pesan1, pesan2;
                            if (m1.getProperty(CONTENT2) != null && m2.getProperty(CONTENT2) != null) {
                                pesan1 = (double) m1.getProperty(CONTENT2);
                                pesan2 = (double) m2.getProperty(CONTENT2);
                                diff = pesan1 - pesan2;
...
//untuk menambahkan interest

    public void setInterest(String a) {
        this.interest.add(a);
    }

    public void resetInterest(String b) {
        this.interest.clear();
        this.interest.add(b);
    }
